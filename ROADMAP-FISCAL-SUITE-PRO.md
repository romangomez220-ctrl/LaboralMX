...
## 2. Fiscal Suite — Free vs. Pro

### Fiscal Suite Free (actual)
...
### Fiscal Suite Pro (futuro, no implementado)
- Guardar cálculos.
...
Mejoras futuras para el formulario de RESICO (y posiblemente otras herramientas de Fiscal Suite),
